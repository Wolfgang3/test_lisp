...
(defun make-content-of-everything (&key release-id)
  ...
  (add-all-object-data-to-content :release-id release-id :obj-list commit-obj-list :table-id 'c_id :id-method 'commit-id :title-method 'commit-message :date-method 'commit-date)
  (add-all-object-data-to-content :release-id release-id :obj-list pr-obj-list :table-id 'p_id :id-method 'pull-request-id :title-method 'pull-request-title :date-method 'pull-request-date)
  (add-all-object-data-to-content :release-id release-id :obj-list task-obj-list :table-id 't_id :id-method 'task-id :title-method 'task-name :date-method 'task-completed-at)
  ))
